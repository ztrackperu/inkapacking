...
function validar($valor){
    ...
    //$res = in_array($valor, $datosDepurar);
    if(in_array($valor, $datosDepurar) || $valor == null)
    {
        $valor = 'NA';
    }else{
        $valor;
...
function validarSp($valor){
    if($valor>=-40 && $valor<=150){
        return $valor;
    }else{
        return 'NA';
    }
}
function cambiarFomatoFecha($fecha){
    $fecha = str_replace("T", " ", $fecha);
    $res = date('Y-m-d H:i:s', strtotime($fecha));
    return $res;
}

function validarH($valor){
...
function modalReporte($fila){
    $text = "<h1>Ripener - {$fila->nombre_contenedor}</h1>
            <input type='hidden' id='nombre_contenedor' value='{$fila->nombre_contenedor}'>
            <div class='row'>
                <div class='d-flex flex-wrap justify-content-center col-12'>
                    <div class='col-12 mt-4'>
                        <button type='button' class='btn btn-success w-100' onclick='reportToday($fila->telemetria_id)'>Today</button>
                    </div>
                    <div class='col-12 mt-4'>
                    ...
                    <div class='col-12 mt-4'>
                        <button type='button' class='btn btn-primary w-100' onclick='procesarReporte($fila->telemetria_id)'>Process</button>
                    </div>
                </div>
            </div>
...
function ContenedorMadurador_2($val, $url=0){ 
    ...
    $co2_pr = validarco2($val->co2_reading);
                    ...
                    <div class='card'>
                        <div class='card-body'>
                            <div class='d-flex justify-content-center'>
                                ...
                                <!-- aqui va la cosa -->
                            <input type='hidden' id='imei_contenedor' value='{$val->imei}'>
                            <div class='mt-5 border rounded px-3' id='alerta_{$val->imei}'>
                                <!--alerta-->
                            </div>
                            <div class='d-flex flex-wrap justify-content-center mt-2' >
                                ...
                                <div class='btn btn-group border-0'>
                                    <button type='button' class='btn btn-primary border-0'>°C</button>
                                    <button type='button' class='btn disabled'>°F</button>
                                </div>
                                <!--
                            ...
                            <div class='col-12 d-flex flex-wrap justify-content-center gap-2 py-3'>
                                <a type='button' class='btn col-5 col-sm-5 col-md-3 col-lg-3 col-xl-1 btn-main align-content-center' style='background-color:#032338; color:white;' href='{$base_url}Graph/index/{$val->telemetria_id}/{$val->nombre_contenedor}'><i class='ri-line-chart-line icon-main'></i>Graph</a>
                                <a type='button' class='btn col-5 col-sm-5 col-md-3 col-lg-3 col-xl-1 btn-main align-content-center' style='background-color:#032338; color:white;' href='{$base_url}Data/index/{$val->telemetria_id}/{$val->nombre_contenedor}';><i class='ri-article-line icon-main'></i>Data</a>
                                <a type='button' class='btn col-10 col-sm-10 col-md-3 col-lg-3 col-xl-2 btn-main align-content-center' style='background-color:#032338; color:white;' href='{$base_url}Ripener/index/{$val->telemetria_id}/{$val->nombre_contenedor}/{$val->imei}';><i class='ri-settings-3-fill icon-main'></i>Modo Ripener</a>
                                <a type='button' class='btn col-5 col-sm-5 col-md-3 col-lg-3 col-xl-1 btn-main align-content-center' style='background-color:#032338; color:white;' href='{$base_url}Control/index/{$val->telemetria_id}/{$val->nombre_contenedor}/{$val->imei}';><i class='ri-remote-control-line icon-main'></i>Control</a>
                                <button type='button' class='btn col-5 col-sm-5 col-md-3 col-lg-3 col-xl-1 btn-main align-content-center' style='background-color:#032338; color:white;' onclick='modalReporte($val->telemetria_id)'><i class='ri-file-chart-fill icon-main'></i>Report</button>
                            </div>
                        </div>
                        <div class='col-6 col-lg-3 border-top'>
                            <div class='text-center'>
                                <i class='ri-shut-down-line fs-1 {$icon}'></i>
                        ...
                        <div class='col-6 col-lg-3 border-top'>
                            <div class='text-center'>
                                <i class='ri-temp-cold-line fs-1'></i>
                            ...
                            <div class='text-center'>
                                <svg version='1.0' xmlns='http://www.w3.org/2000/svg' class='icon-params px-1'
                                    ...
                                    <g transform='translate(0.000000,66.000000) scale(0.100000,-0.100000)'
                                        ...
                                        <path d='M432 543 c-23 -20 -41 -73 -24 -73 5 0 15 13 22 30 21 50 86 53 108 5 14 -29 2 -69 -23 -79 -9 -3 -104 -6 -211 -6 -123 0 -194 -4 -194 -10 0 -13 395 -13 420 0 25 13 41 65 30 94 -19 52 -88 72 -128 39z'/>
                                        <path d='M635 465 c-24 -23 -36 -73 -15 -60 6 3 10 12 10 19 0 19 34 46 58 46 51 0 81 -70 44 -103 -16 -15 -50 -17 -268 -17 -143 0 -255 -4 -264 -10 -10 -6 78 -10 257 -10 l272 0 20 26 c29 37 26 70 -8 105 -36 36 -73 37 -106 4z'/>
                                        <path d='M155 250 c4 -6 85 -10 211 -10 191 0 205 -1 224 -20 25 -25 25 -55 0 -80 -36 -36 -82 -21 -105 35 -8 19 -9 18 -13 -5 -8 -49 76 -90 119 -57 27 20 41 56 34 88 -12 55 -28 59 -263 59 -140 0 -211 -3 -207 -10z'/>
                                    </g>
                                </svg>
                        ...
                        <div class='col-6 col-lg-3 border-top'>
                            <div class='text-center'>
                                <svg version='1.0' xmlns='http://www.w3.org/2000/svg'
                                    ...
                                    fill='#000000' stroke='none'>
                                    <path d='M275 579 c-40 -12 -58 -28 -84 -69 -38 -62 -21 -148 38 -191 46 -34 41 -53 -11 -45 -49 7 -48 7 -145 0 l-73 -6 0 -99 0 -99 68 -1 c112 0 422 -1 500 0 l72 1 0 99 0 99 -72 6 c-98 7 -97 7 -145 0 -52 -7 -58 11 -15 43 34 25
                        ...
                        <div class='col-6 col-lg-3 border-top'>
                            <div class='text-center'>
                                ...
                                <div class='d-flex justify-content-center align-content-center'>
                                    ...
                                    <label for='avl' class='fw-bold value_params value_icon' id='avl_{$val->telemetria_id}'>{$avl_f} CFM</label>
                                </div>
                            </div>
                        </div>
                        <div class='col-6 col-lg-3 border-top hide-content-humidity_{$val->telemetria_id}' hidden>
                            <div class='text-center'>
                        ...
                        <div class='col-6 col-lg-3 border-top hide-content-compressor_{$val->telemetria_id}' hidden>
                            <div class='text-center '>
                                <svg version='1.0' xmlns='http://www.w3.org/2000/svg'
                                ...
                                <div class='d-flex justify-content-center align-content-center'>
                                    ...
                                    <label for='compressor' class='fw-bold value_params value_icon' id='compressor_{$val->telemetria_id}'>{$compress_coil_1_f} C°</label>
                                </div>
                            </div>
                        </div>
                        <div class='col-6 col-lg-3 border-top hide-content-evaporator_{$val->telemetria_id}' hidden>
                            <div class='text-center'>
                        ...
                        <div class='col-6 col-lg-3 border-top hide-content-ambientair_{$val->telemetria_id}' hidden>
                            <div class='text-center '>
                        ...
                        <div class='col-6 col-lg-3 border-top border-bottom hide-content-pwd_{$val->telemetria_id}' hidden>
                            <div class='text-center'>
                        ...
                        <div class='col-6 col-lg-3 border-top border-bottom hide-content-cmode_{$val->telemetria_id}' hidden>
                            <div class='text-center '>
                        ...
                        <div class='col-6 col-lg-3 border-top border-bottom hide-content-usda1_{$val->telemetria_id}' hidden>
                            <div class='text-center '>
                        ...
                        <div class='col-6 col-lg-3 border-top border-bottom hide-content-usda4_{$val->telemetria_id}' hidden>
                            <div class='text-center'>
                                <i class='bi bi-eyedropper fs-1'></i>
                        ...
                        <div class='col-6 col-lg-3'>
                            <div class='text-center'>
                                <button class='btn rounded-circle' style='background-color:#032338; color:white;' onclick='mostrarContenido({$val->telemetria_id})'>
